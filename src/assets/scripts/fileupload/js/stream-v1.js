...
define([
	...
	"ts/util/Format",
	"dojo/text!fileupload/htm/stream-v1.htm",
	"dojo/css!fileupload/css/stream-v1.css",
	...
	function Main(cfg){
		...
		this.config = {
			...
			dragAndDropTips: cfg.dragAndDropTips || '<span>'+ i18n.getMessage("dropFileHere")+'</span>',
			fileFieldName : 'FileData',
			browseFileId : cfg.browseFileId || 'i_select_files',
			browseFileBtn : cfg.browseFileBtn || '<div>'+i18n.getMessage("chooseFile")+'</div>',
