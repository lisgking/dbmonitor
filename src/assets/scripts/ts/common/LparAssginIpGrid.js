define("ts/common/LparAssginIpGrid",
	["ts/widgets/TSDataFormGrid",
	 "ts/widgets/TSGridColumn",
	 "ts/widgets/TSTextField",
	 "dojo/text!ts/common/LparAssginIpGrid.html",
	...
	function LparAssginIpGrid(opts){
	...
	ExtendClass(LparAssginIpGrid,TSDataFormGrid);
	
	InstallFunctions(LparAssginIpGrid.prototype,DONT_DELETE,[
	    "loadData",loadData,
	    "getData",getData,
	    "validate",validate
	]);
	SetProperties(LparAssginIpGrid.prototype,DONT_ENUM,[
	    "template",html,
	    "i18n",i18n
	]);
	
	return LparAssginIpGrid;
