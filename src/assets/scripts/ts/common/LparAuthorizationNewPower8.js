define('ts/common/LparAuthorizationNewPower8', [
	...
	function LparAuthorizationNewPower8(opts){
    ...
    ExtendClass(LparAuthorizationNewPower8, TSFormTest);
    InstallFunctions(LparAuthorizationNewPower8.prototype, DONT_ENUM,[ 
    ...
    SetProperties(LparAuthorizationNewPower8.prototype, DONT_ENUM, [ 
          "template",html,
          "i18n", i18n 
    ]);
	return LparAuthorizationNewPower8;
});