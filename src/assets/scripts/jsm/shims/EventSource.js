...
define([
...
],function (EventTarget,Event,MessageEvent) {
  "use strict";
  var global=window,
    XHR = global.XMLHttpRequest,
    XDR = global.XDomainRequest,
    isCORSSupported = Boolean(XHR && ((new XHR()).withCredentials !== undefined)),
    isXHR = isCORSSupported,
    Transport = isCORSSupported ? XHR : XDR;
  var WAITING = -1,
    CONNECTING = 0,
    OPEN = 1,
    CLOSED = 2,
  ...
  function F() {
    SetProperties(this,READ_ONLY|DONT_ENUM|DONT_DELETE,[
      "CONNECTING",CONNECTING,
      "OPEN",OPEN,
      "CLOSED",CLOSED
    ]);
  }
  ExtendClass(EventSource,EventTarget);
  F.call(EventSource.prototype);
  F.call(EventSource);
  if (Transport) {
